...
import static com.zhiqing.recyclerview_lib.recyclerview.widget.RecyclerView.ItemAnimator.*;
        ...
        void onAnimation(int dx, int dy) {
            ...
            if (mPendingInitialRun && mTargetView == null && mLayoutManager != null) {
                ...
                if (pointF != null && (pointF.x != 0 || pointF.y != 0)) {
                    Log.d("lzqtest","RecyclerView.java.onAnimation: 11648 ");
            ...
            if (mTargetView != null) {
                ...
                if (getChildPosition(mTargetView) == mTargetPosition) {
                    Log.d("lzqtest", "onAnimation: pre mRecyclingAction.toString()"+ mRecyclingAction.toString());;
                    onTargetFound(mTargetView, recyclerView.mState, mRecyclingAction);
                    Log.d("lzqtest","RonAnimation: after mRecyclingAction.toString()"+ mRecyclingAction.toString());
